...
public class BankProductController implements ProductsApi {
    ...
    @Override
    public Mono<ResponseEntity<BankProductTemplateResponse>> getAllProducts
    ...
    @Override
    public Mono<ResponseEntity<BankProductTemplateResponse>> getAllProductsByCustomerId
    ...
    @Override
    public Mono<ResponseEntity<BankProductTemplateResponse>> getProductById
            (String id, ServerWebExchange exchange) {
    ...
    @Override
    public Mono<ResponseEntity<BankProductTemplateResponse>> createProduct
    ...
    @Override
    public Mono<ResponseEntity<BankProductTemplateResponse>> updateProduct(
            String id,
    ...
    @Override
    public Mono<ResponseEntity<BankProductTemplateResponse>> deleteProduct
            (String id, ServerWebExchange exchange) {
